...
const videoContainers = document.querySelectorAll('.about-wooder__video');

videoContainers.forEach(function addListenersToEachVideo(videoContainer) {
  videoContainer.addEventListener('click', function videoTrigger(e) {
    console.log(e.target);
    if (!e.target.classList.contains('about-wooder__video')) {
      this.querySelector('.about-wooder__video-player-wrapper').style.display = 'flex';
    }
    if (e.target.classList.contains('about-wooder__video-player-wrapper')) {
      this.querySelector('.about-wooder__video-player-wrapper').style.display = 'none';
    }
  });
});
